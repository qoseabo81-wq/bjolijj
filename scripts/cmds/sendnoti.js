    ...
    config: {
      ...
      guide: {
        vi: "   {pn} create <groupName>: Tạo một group noti (notification) mới với tên gọi <groupName>" +
          ...
          "\n   Ví dụ:\n    {pn} remove TEAM1",
        en: {
          "{pn} create <اسم المجموعة>: إنشاء مجموعة إشعارات جديدة باسم <اسم المجموعة>" +
          "\n مثال:\n {pn} create الفريق1" +
          "\n\n {pn} add <اسم المجموعة>: إضافة محادثة الصندوق الحالية إلى مجموعة الإشعارات <اسم المجموعة> (يجب أن تكون مشرفًا في محادثة الصندوق هذه)" +
          "\n مثال:\n {pn} add الفريق1" +
          "\n\n {pn} list: عرض قائمة مجموعات الإشعارات التي تديرها" +
          "\n\n {pn} info <اسم المجموعة>: عرض معلومات مجموعة الإشعارات <اسم المجموعة>" +
          "\n\n {pn} delete <اسم المجموعة>: حذف محادثة الصندوق الحالية من مجموعة الإشعارات <اسم المجموعة> (يجب أن تكون منشئ هذه المجموعة)" +
          "\n مثال:\n {pn} delete الفريق1" +
          "\n\n {pn} send <اسم المجموعة> | <رسالة>: إرسال إشعار إلى جميع المجموعات في مجموعة الإشعارات <اسم المجموعة> (يجب أن تكون مشرفًا في تلك المجموعات)" +
          "\n مثال:\n غير صحيح:  {pn} send TEAM1 | hi" +
          "\n\n {pn} remove <اسم المجموعة>: حذف مجموعة الإشعارات <اسم المجموعة> (يجب أن تكون منشئ مجموعة الإشعارات <اسم المجموعة>)" +
          "\n مثال:\n {pn} remove الفريق1"
        }
      },
      ...
      langs: {
        ...
        en: {
          
          {
            ...
            groupNameExists: "مجموعة الإشعارات باسم %1 تم إنشاؤها من قبلك سابقًا، يرجى اختيار اسم آخر",
            createdGroup: "تم إنشاء مجموعة الإشعارات بنجاح:\n- الاسم: %1\n- المعرف: %2",
            missingGroupNameToAdd: "يرجى إدخال اسم مجموعة الإشعارات التي تريد إضافة محادثة المجموعة هذه إليها",
            groupNameNotExists: "لم تقم بإنشاء/إدارة أي مجموعة إشعارات باسم: %1",
            notAdmin: "أنت لست مشرفًا في محادثة المجموعة هذه",
            added: "تم إضافة محادثة المجموعة الحالية إلى مجموعة الإشعارات: %1",
            missingGroupNameToDelete: "يرجى إدخال اسم مجموعة الإشعارات التي تريد حذف محادثة المجموعة هذه من القائمة",
            notInGroup: "محادثة المجموعة الحالية ليست في مجموعة الإشعارات %1",
            emptyList: "لم تقم بإنشاء/إدارة أي مجموعة إشعارات",
            showList: "قائمة مجموعات الإشعارات التي تديرها:\nتظهر بالتنسيق:\n<اسم مجموعة الإشعارات> - <عدد المجموعات في مجموعة الإشعارات>\n%1",
            deleted: "تم حذف محادثة المجموعة الحالية من مجموعة الإشعارات: %1",
            failed: "فشل في إرسال الإشعار إلى %1 محادثات المجموعة: \n%2",
            ...
            sending: "جارٍ إرسال الإشعار إلى %1 محادثات المجموعة",
            success: "تم إرسال الإشعار إلى %1 محادثات المجموعة في مجموعة الإشعارات " % 2 " بنجاح",
            ...
            groupInfoHasGroup: "- محادثات المجموعة:\n%1",
