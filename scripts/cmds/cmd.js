...
module.exports = {
  config: {
    ...
    guide: {
      ...
      en: " {pn} تحميل <اسم الملف>: لتحميل أمر محدد" + "\n {pn} تحميل الكل: لتحميل جميع الأوامر" + "\n {pn} تثبيت <الرابط> <الاسم>: لتثبيت أمر من رابط" + "\n {pn} تثبيت <الاسم> <الكود>: لتثبيت أمر من كود مباشر"
  ...
  langs: {
    en: {
      ...
      loadedError: "❌ | فشل في تحميل الأمر \"%1\" مع وجود خطأ\n%2: %3",
      loadedSuccess: "✅ | تم تحميل (%1) أمر بنجاح",
      loadedFail: "❌ | فشل في تحميل (%1) أمر\n%2",
      openConsoleToSeeError: "👀 | افتح وحدة التحكم لمشاهدة تفاصيل الخطأ",
      missingCommandNameUnload: "⚠️ | يرجى إدخال اسم الأمر الذي تريد إلغاء تحميله",
      unloaded: "✅ | تم إلغاء تحميل الأمر \"%1\" بنجاح",
      unloadedError: "❌ | فشل في إلغاء تحميل الأمر \"%1\" مع وجود خطأ\n%2: %3",
      missingUrlCodeOrFileName: "⚠️ | يرجى إدخال الرابط أو الكود واسم ملف الأمر الذي تريد تثبيته",
      missingUrlOrCode: "⚠️ | يرجى إدخال الرابط أو الكود لملف الأمر الذي تريد تثبيته",
      ...
      alreadExist: "⚠️ | ملف الأمر موجود مسبقًا، هل تريد استبدال الملف القديم؟\nقم بالرد على هذه الرسالة للمتابعة",
      installed: "✅ | تم تثبيت الأمر \"%1\" بنجاح، الملف محفوظ في %2",
      installedError: "❌ | فشل في تثبيت الأمر \"%1\" مع وجود خطأ\n%2: %3",
