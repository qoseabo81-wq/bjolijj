...
module.exports = {
  config: {
    ...
    guide: {
      vi: "   {pn} [add | -a] <nội quy muốn thêm>: thêm nội quy cho nhóm." +
        ...
        "\n    {pn} -r",
      en: "   {pn} [add | -a] <rule to add>: لإضافة قواعد للمجموعه." +
        "\n   {pn}: view group rules." +
  ...
  langs: {
    ...
    en:
    {
      ...
      noRules: "مجموعتك لا تحتوي على قواعد، لإضافة قواعد للمجموعة استخدم `%1rules add`",
      noPermissionAdd: "فقط الإداريون يمكنهم إضافة قواعد للمجموعة",
      noContent: "يرجى إدخال محتوى القاعدة التي تريد إضافتها",
      success: "تم إضافة قاعدة جديدة للمجموعة بنجاح",
      noPermissionEdit: "فقط الإداريون يمكنهم تعديل قواعد المجموعة",
      invalidNumber: "يرجى إدخال رقم القاعدة التي تريد تعديلها",
      rulesNotExist: "القاعدة رقم %1 غير موجودة",
      numberRules: "مجموعتك تحتوي على %1 قواعد فقط",
      noContentEdit: "يرجى إدخال المحتوى الذي تريد تغييره للقاعدة رقم %1",
      successEdit: "تم تعديل القاعدة رقم %1 إلى: %2",
      noPermissionMove: "فقط الإداريون يمكنهم نقل قواعد المجموعة",
      invalidNumberMove: "يرجى إدخال رقم القاعدتين اللتين تريد تبديلهما",
      sameNumberMove: "لا يمكن تبديل موضع قاعدتين متشابهتين",
      rulesNotExistMove2: "القاعدة رقم %1 و %2 غير موجودتين",
      successMove: "تم تبديل موضع القاعدة رقم %1 و %2 بنجاح",
      noPermissionDelete: "فقط الإداريون يمكنهم حذف قواعد المجموعة",
      ...
      noPermissionRemove: "فقط إداريو المجموعة يمكنهم حذف جميع قواعد المجموعة",
      confirmRemove: "⚠️ قم بالتفاعل مع هذه الرسالة بأي إيموجي لتأكيد حذف جميع قواعد المجموعة",
