...
module.exports = {
  config: {
    ...
    guide: {
      ...
      en: "{p}{n} <معرف الشخصية أو اسم الشخصية> | <النص الخلفية> | <التوقيع> | <اسم لون الخلفية أو رمز اللون السداسي>" + "\n {p}{n} مساعدة: عرض كيفية استخدام هذا الأمر"
    }
  },
  ...
  langs: {
    ...
    en: {
      ...
      invalidCharacter: "يوجد حاليًا %1 شخصيات فقط في النظام، يرجى إدخال معرف شخصية أقل من",
